...
for suffix in "${suffixes[@]}"; do
    ...
    CSV_NAME="import/hetnet_edges$suffix"

    REPORT_NAME="network${suffix}_import.report"

    ./$BIN_LOC import --nodes "import/hetnet_nodes.csv" --relationships "${CSV_NAME}.csv" --report-file="$REPORT_NAME"
